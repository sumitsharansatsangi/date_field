          ...
          child: Center(
            ...
            child: ListView(
              children: [
                ...
                Obx(() => DropDownSearchField<ItemVariant>(
                ...
                Obx(() => DropDownSearchField<Supplier>(
                ...
                Obx(() => CustomDateField(
                      ...
                      initialDate: c.purchasedDate.value,
                      validator: (value) {
                        if (value == null) {
                          return null;
                ...
                Obx(() => CustomDateField(
                      ...
                      hint: DateTime.now().toString(),
                      initialDate: c.expiryDate.value,
                      validator: (value) {
                        if (value == null) {
                          return null;
                      ...
                      onDateSelected: (DateTime value) {
                        c.expiryDate.value = value;
                      },
                    )),
                Obx(() => DropDownMultiSearchField<Godown>(
                      onPressed: () async {
                ...
                Obx(() => DropDownMultiSearchField<StoreRoom>(
                      onPressed: () async {
                      ...
                      onChanged: (storeRooms) {
                        if (storeRooms != null) {
                          for (final storeRoom in storeRooms) {
                            c.selectedStoreRooms.add(StoredAtStoreRoom()
                              ..storeRoom.target = storeRoom);
                          }
                          c.fetchAlmirah([
                ...
                Obx(() => DropDownMultiSearchField<Almirah>(
                      onPressed: () async {
                      ...
                      onChanged: (almirahs) {
                        if (almirahs != null) {
                          for (final almirah in almirahs) {
                            c.selectedAlmirahs.add(
                                StoredAtAlmirah()..almirah.target = almirah);
                          }
                        }
                      },
                      selectedItems: [
